...
public class CategoryService
{
    ...
    private static readonly (string Name, string Description)[] _defaultCategories = new[]
    {
        ...
        // ── 10. Цифровые компетенции и IT ──────────────────────────────────────
        ("Программирование", "Алгоритмы, структуры данных, ООП, веб-разработка"),
        ("Робототехника", "Построение и программирование роботов, Arduino, Raspberry Pi"),
        ("Кибербезопасность", "Защита данных, шифрование, защита от вредоносного ПО"),
        ("Data Science", "Анализ данных, машинное обучение, визуализация, Python/R"),
        ("Веб-разработка", "Frontend, backend, фреймворки, API, базы данных"),
        ("Мобильная разработка", "iOS, Android, кроссплатформенные приложения"),

        // ── 11. Экономика и финансы ───────────────────────────────────────────
        ("Бизнес и предпринимательство", "Бизнес-планирование, стартапы, управление"),
        ("Инвестирование и трейдинг", "Фондовый рынок, форекс, инвестиционные стратегии"),
        ("Бухгалтерия", "Финансовый учёт, отчётность, налогообложение"),

        // ── 12. Жизненные навыки ──────────────────────────────────────────────
        ("Эмоциональный интеллект", "Самосознание, эмпатия, управление эмоциями"),
        ("Коммуникация", "Переговоры, презентации, убеждение, публичные выступления"),
        ("Лидерство", "Руководство, мотивация команды, принятие решений"),
        ("Тайм-менеджмент", "Планирование, прокрастинация, продуктивность"),
    };
